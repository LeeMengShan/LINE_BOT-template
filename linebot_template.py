...
line_bot_api = LineBotApi(
    'P28kcFfvAv6g6P3hfudGCerIjEWGt46mxrzhCjSrJYcgq2NWTzUuonOKAI6DI5nW35U0ae9ZjcO16GEvqG0mfa3md5Ty/6n7rkpNNSzuIrgWSywBa09J+qpSmb+xIqdZazhCiaWNrAGRcc6JM3XSaAdB04t89/1O/w1cDnyilFU=')
handler = WebhookHandler('8f0d87b0cb9209fd66affcb0aec996ce')
...
def get_reply_messages(data):
    ...
    reply_table = pd.read_excel(
        'reply_messages.xlsx', engine='openpyxl')
...
def handle_message(event):
    ...
    if msgtxt == "#replay":
        line_bot_api.reply_message(
            event.reply_token, get_reply_messages("section=narrate&action=ch1-1"))
